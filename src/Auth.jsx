...
const API_URL = import.meta.env.VITE_API_URL || "https://nexapay-wallet.onrender.com/api";
...
export default function Auth() {
  ...
  return (
    <main className="min-h-[80vh] w-full p-8 bg-gradient-to-br from-slate-950/70 via-blue-950/70 to-black/70 text-slate-100 flex items-center justify-center backdrop-blur-sm">
      <div className="w-full max-w-xl rounded-3xl border border-white/10 bg-white/10 p-8 backdrop-blur-xl shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <input 
            ...
            className="glass-input bg-white/10 text-slate-100 placeholder-slate-400" 
          />
          <input 
            required 
            value={password} 
        ...
        <p className="mt-6 text-center text-slate-300">
          ...
          <Link className="text-cyan-300 hover:underline" to={mode === "signup" ? "/auth?mode=signin" : "/auth?mode=signup"}>
