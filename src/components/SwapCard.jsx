  ...
  return (
    <div className="bg-[#1e2329] border border-white/5 rounded-[2.5rem] p-8 shadow-2xl relative overflow-hidden group">
      ...
      <div className="space-y-2 relative z-10">
        {/* FROM ASSET */}
        <div className="bg-black/40 border border-white/5 rounded-[1.5rem] p-6 focus-within:border-cyan-500/50 transition-all">
        ...
        {/* TO ASSET */}
        <div className="bg-black/40 border border-white/5 rounded-[1.5rem] p-6">
          <div className="flex justify-between items-center mb-4">
