...
export default function Navbar({ setOpen }) {
  ...
  return (
    <div className="flex items-center justify-between px-8 py-4 bg-[#0b0e11]/95 backdrop-blur-2xl border-b border-white/5 sticky top-0 z-[60] md:ml-72 h-20 shadow-2xl shadow-black/80">
      ...
      <div className="flex items-center gap-6">
        <h1 className="font-black text-white text-2xl tracking-tighter hidden lg:block">NexaPay</h1>
      ...
      <div className="flex items-center gap-3">
        ...
        <button 
          ...
          className="w-11 h-11 bg-white/5 hover:bg-white/10 border border-white/10 rounded-2xl flex items-center justify-center text-gray-400 hover:text-cyan-400 transition-all shadow-xl active:scale-90"
        ...
        <div className="relative">
          <button 
            ...
            className="flex items-center gap-4 bg-white/5 hover:bg-white/10 px-5 py-2.5 rounded-2xl border border-white/10 transition-all group shadow-xl"
          >
            <div className="w-9 h-9 rounded-xl bg-cyan-500/20 flex items-center justify-center text-cyan-400 group-hover:bg-cyan-500 group-hover:text-black transition-all shadow-inner">
