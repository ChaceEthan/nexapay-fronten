...
import SystemStabilizer from "@components/SystemStabilizer.jsx";
...
function App() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("pagehide", clearSessionState);
    return () => window.removeEventListener("pagehide", clearSessionState);
  }, []);
